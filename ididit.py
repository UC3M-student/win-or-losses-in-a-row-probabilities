...
def rowtimes(last_win_or_lose_def) : #probabilities in a row
    ...
    if i == "W" : 
        ...
        two_lose_in_a_row = first[1,0] #next win 
        three_lose_in_a_row = first[1,0]**2
...
second = last_win_or_lose("D:\VSCODE projects\Golden State Warriors\Excell data\Wolden State Warriors.xls")
print(second)


third = rowtimes(second) 
