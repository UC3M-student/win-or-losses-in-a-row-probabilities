...
def nba_teams_prob_excell(path_to_all_excels):
    ...
    for i in file_list:
            ...
            for a in results:
                a
            if a == "W" : 
                two_wins_in_a_row = matrix_probailities[1,1] #win the next game
                three_wins_in_a_row = matrix_probailities[1,1]**2 #win the nexr 2 games
                four_wins_in_a_row = matrix_probailities[1,1]**3
                five_wins_in_a_row = matrix_probailities[1,1]**4
                six_wins_in_a_row = matrix_probailities[1,1]**5
                seven_wins_in_a_row = matrix_probailities[1,1]**6
                eight_wins_in_a_row = matrix_probailities[1,1]**7
                nine_wins_in_a_row = matrix_probailities[1,1]**8
                ten_wins_in_a_row = matrix_probailities[1,1]**9
                ...
                two_lose_in_a_row = matrix_probailities[1,1] #win the next game
                three_lose_in_a_row = matrix_probailities[1,1]**2 #win the next two games 
                four_lose_in_a_row = matrix_probailities[1,1]**3
                five_lose_in_a_row = matrix_probailities[1,1]**4
                six_lose_in_a_row = matrix_probailities[1,1]**5
                seven_lose_in_a_row = matrix_probailities[1,1]**6
                eight_lose_in_a_row = matrix_probailities[1,1]**7
                nine_lose_in_a_row = matrix_probailities[1,1]**8
                ten_lose_in_a_row = matrix_probailities[1,1]**9
            ...
            excl_merged.to_excel("all_probs_nba_teams_loose.xls", index= False) #all_data_merged
            print("Done")
